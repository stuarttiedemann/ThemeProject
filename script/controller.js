angular.module('myApp',[]).controller('myController',function($scope){
	...
	$scope.projects.push(new $scope.Project("Google Maps API Integration","img/work/googlemaps.png","http://googlemapsapi.bitballoon.com/","Use Google Maps API to find directions, lodging, and grocery stores for a selected location."));
	...
	$scope.projects.push(new $scope.Project("Weather App Using Open Weather API","img/work/WeatherApp.png","http://stuarttiedemann.com/weather/","Use OpenWeatherMap API to retrieve current conditions and five day forecast for any location."));
