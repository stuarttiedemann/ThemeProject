angular.module('myApp',[]).controller('myController',function($scope){
	...
	$scope.projects=[];
	$scope.projects.push(new $scope.Project("Google Maps API","img/work/googlemaps.png","http://stuarttiedemann.com/googlemaps/"));
	...
	$scope.projects.push(new $scope.Project("Yahoo Stocks API","img/work/stocks.png","http://stuarttiedemann/angular-stocks.git"));
	$scope.projects.push(new $scope.Project("Weather App API","img/work/WeatherApp.png","http://stuarttiedemann.com/planeroutes/#/"));
